...
<img src="https://user-images.githubusercontent.com/7-7-7-8/ion-ai.png" alt="ION AI Apps Screenshot" width="700"/>

---

## 🕵️ Proxies

Recognizing the need for privacy and unrestricted browsing, ION features a robust **Proxies** section, where users can launch various proxy services such as DOGE, FreedomProject, Nebula, RammerHead, ShadowBrowser, and UvStaticV2. Each proxy is accessible through the same intuitive modal popup system, allowing for safe, incognito browsing within the ION interface. To enhance security, this section is password-protected and includes warnings to ensure users understand the risks and responsibilities of using proxy services.

<img src="https://user-images.githubusercontent.com/7-7-7-8/ion-proxies.png" alt="ION Proxies Screenshot" width="700"/>
...
<img src="https://user-images.githubusercontent.com/7-7-7-8/ion-settings.png" alt="ION Settings Screenshot" width="600"/>
...
Here are some screenshots of ION in action:

| ![Games](https://user-images.githubusercontent.com/7-7-7-8/ion-games.png) | ![AI Apps](https://user-images.githubusercontent.com/7-7-7-8/ion-ai.png) |
|:--:|:--:|
| _Game Selection & Ifame Modal_ | _AI App Launch in Modal_ |

| ![Proxies](https://user-images.githubusercontent.com/7-7-7-8/ion-proxies.png) | ![Settings](https://user-images.githubusercontent.com/7-7-7-8/ion-settings.png) |
|:--:|:--:|
| _Proxy Vault with Password_ | _Quick Settings & Cloaking_ |
...
> **Made with ❤️ by [7-7-7-8](https://github.com/7-7-7-8/ION)**
